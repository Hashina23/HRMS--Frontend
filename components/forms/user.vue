...
export default{
    ...
    data(){
        return{
            ...
            companyRules: [
                v => !!v || 'Syarikat diperlukan',
            ],
            positionRules: [
                v => !!v || 'Jawatan diperlukan',
            ],
            usernameRules: [
                v => !!v || 'Nama akaun diperlukan',
                v => (v && v.length <= 20) || 'Nama akaun mesti kurang dari 20 aksara',
            ],
            passwordRules: [
                v => !!v || 'Kata laluan diperlukan',
                v => (v && v.length >= 6) || 'Kata laluan mesti sekurang-kurangnya 6 aksara',
            ],
        }
    },
    methods: {
